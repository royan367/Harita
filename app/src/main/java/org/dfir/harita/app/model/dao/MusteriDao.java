...
/** 
 * DAO for table MUSTERI.
*/
public class MusteriDao extends AbstractDao<Musteri, Long> {

    public static final String TABLENAME = "MUSTERI";

    /**
     * Properties of entity Musteri.<br/>
    ...
    */
    ...
    public MusteriDao(DaoConfig config) {
        super(config);
    }
    
    public MusteriDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MUSTERI'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Musteri entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(Musteri entity) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Musteri entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Musteri entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
